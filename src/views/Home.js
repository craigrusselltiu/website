        ...
        <>
            <TextPhotoPair
                ...
                text="Hey! My name's Craig and I'm a passionate software engineer. I'm a people person, problem solver, and a naturally techy guy —
                    ...
                    Technology has always and will always pique my interest, but at the end of the day I'm just a regular guy who happened to completely fall in love with coding.
            ...
            <TextPhotoPair
                ...
                text="In my spare time I like to travel and explore new things (admittedly mostly for food), keep up with whatever Elon Musk is up to, and play the piano to wind down and destress.
                    I've also recently been exploring custom mechanical keyboards, and am putting together one of my own.
                    Working on meaningful side projects like this portfolio is something that I enjoy doing as well, keeping me sharp and on my toes at all times."
                img={pic2}
                sig={'Kyoto, 2018'}
            />
